...
const THEMES: Record<number, Blob[]> = {
  ...
  // Slide 8 — emerald / blue (customer journey / growth traction)
  8: [
    { color: "rgba(16,185,129,0.24)",  size: 660, ix: -200, iy: -170, ax: [-200,  80, -120, -200], ay: [-170,  70,  200, -170], dur: 14 },
    { color: "rgba(59,130,246,0.17)",  size: 550, ix:  230, iy:  150, ax: [ 230, -60,  270,  230], ay: [ 150, -100,   80,  150], dur: 17 },
    { color: "rgba(52,211,153,0.12)",  size: 450, ix:   80, iy: -220, ax: [  80,-160,  200,   80], ay: [-220,  110,  -80, -220], dur: 21 },
    { color: "rgba(99,102,241,0.08)",  size: 370, ix: -270, iy:  200, ax: [-270, 120, -110, -270], ay: [ 200,  -60,  280,  200], dur: 19 },
  ],
  // Slide 9 — blue / cyan (contact)
  9: [
